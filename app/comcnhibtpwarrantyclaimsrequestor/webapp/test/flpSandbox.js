		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#warrantyclaimsrequestor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"warrantyclaimsrequestor-display-display": {
								"semanticObject": "warrantyclaimsrequestor-display",
								"action": "display",
								...
								"resolutionResult": {
									...
									"url": sap.ui.require.toUrl("com/cnhi/btp/warrantyclaimsrequestor")
								}
							}
						}
					}
