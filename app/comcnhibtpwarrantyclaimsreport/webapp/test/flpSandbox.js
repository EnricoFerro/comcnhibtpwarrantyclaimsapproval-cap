		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#warrantyclaimsreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"warrantyclaimsreport-display-display": {
								"semanticObject": "warrantyclaimsreport-display",
								"action": "display",
								...
								"resolutionResult": {
									...
									"url": sap.ui.require.toUrl("com/cnhi/btp/warrantyclaimsreport")
								}
							}
						}
					}
