sap.ui.define([
    ...
    function (BaseController, MessageBox, Filter, FilterOperator, MessageToast, History, Sorter, ReqHelper, BusyIndicator) {
        "use strict";
        var sServiceUrl;
        return BaseController.extend("com.cnhi.btp.warrantyclaimsrequestor.controller.Detail", {
            ...
            */
            ...
            onItemDetailOpen: function (oEvent) {
                if (!this.oItemDetailDlg) {
                    this.oItemDetailDlg = sap.ui.xmlfragment("com.cnhi.btp.warrantyclaimsrequestor.fragment.ItemDetail", this);
            ...
            onDefectDetailOpen: function (oEvent) {
                if (!this.oDefectDetail) {
                    this.oDefectDetail = sap.ui.xmlfragment("com.cnhi.btp.warrantyclaimsrequestor.fragment.DefectExposed", this);
                    // to get access to the controller's model
